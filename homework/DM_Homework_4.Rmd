...
Clustering works better here for distinguishing reds with whites. The process is much more simple and pretty efficient at characterizing the wines. 
```{r pr_plot_wine, echo = FALSE}
```
